...
use crate::mem::validate::validate_mmap;
...
pub unsafe fn boot_kernel(
    ...
    drivers::serial::write_str("attempting validate_mmap\n");

    let boot_info_ref = unsafe { &*boot_info };
    validate_mmap(boot_info_ref);

    drivers::serial::write_str("validate_mmap ok\n");
